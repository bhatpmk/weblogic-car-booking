 ...
 *
 * Chat history is retained on the server by ChatAiService (shared memory). Please adjust the configuration
 * dev.langchain4j.plugin.chat-ai-service-memory.config.maxMessages in app/config/llm-config.properties
 *
 * Usage:
 *   - Default base URL: http://localhost:7001/car-booking/api/car-booking/chat
 *   - Override base URL with the first argument:
 *       java ... ChatClient http://host:port/car-booking/api/car-booking/chat <base URL>
 *
 * Quit:
 *   - Type /quit and hit Enter or or hit Enter on an empty line.
 */
public class ChatClient {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Welcome to Miles of Smiles - Chat Client");
